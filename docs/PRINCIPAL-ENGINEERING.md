...
## Core boundary
**Primary concern:** Feature lifecycle.

Define feature contracts independently of storage/serving adapters; validate freshness and shape; separate offline and online concerns; preserve version/provenance metadata; test consistency failures.
