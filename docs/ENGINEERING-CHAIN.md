...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Feature contracts, freshness/shape validation and online/offline boundaries and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_features.py](../tests/test_features.py) | Contract-focused validation at the repository boundary |
